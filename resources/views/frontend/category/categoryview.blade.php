        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s">
                    <a href="#"><img src="{{asset('/')}}frontend/assets/images/category/category-post-11.jpg" alt=""></a>
                    <div class="post-style2-detail">
                        <h3><a href="#" title="">It uses a dictionary of over 200 Latin words, combined with</a></h3>
                        <div class="date">
                            <ul>
                                <li><img src="{{asset('/')}}frontend/assets/images/comment-01.jpg" class="img-responsive" alt=""></li>
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    <a href="#"><img src="{{asset('/')}}frontend/assets/images/category/category-post-12.jpg" alt=""></a>
                    <div class="post-style2-detail">
                        <h3><a href="#" title="">Lorem Ipsum is simply dummy text of the printing .</a></h3>
                        <div class="date">
                            <ul>
                                <li><img src="{{asset('/')}}frontend/assets/images/comment-02.jpg" class="img-responsive" alt=""></li>
                                <li>By <a title="" href="#"><span>Naeem Khan</span></a> --</li>
                                <li><a title="" href="#">11 Nov 2015</a> --</li>
                                <li><a title="" href="#"><span>275 Comments</span></a></li>
                            </ul>
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                    <a href="#"><img src="{{asset('/')}}frontend/assets/images/category/category-post-13.jpg" alt=""></a>
                    <div class="post-style2-detail">
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                    <a href="#"><img src="{{asset('/')}}frontend/assets/images/category/category-post-14.jpg" alt=""></a>
                    <div class="post-style2-detail">
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                    <a href="#"><img src="{{asset('/')}}frontend/assets/images/category/category-post-15.jpg" alt=""></a>
                    <div class="post-style2-detail">
